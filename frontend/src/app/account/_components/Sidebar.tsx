...
export const Sidebar = () => {
  ...
  const sideNavLinks = [
    { icon: "person", label: "Profil", href: "/account" },
    { icon: "search", label: "Recherche", href: "/account/search" },
    { icon: "domain", label: "Domaines", href: "/account/domains" },
  ];
  ...
  return (
    <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 border-r border-slate-800/30 bg-slate-950 flex flex-col gap-2 p-4 font-manrope text-sm hidden md:flex">
      <div className="mb-6 px-4 pt-4">
        <h2 className="text-lg font-black text-emerald-100">Paramètres</h2>
